...
public class JunctionChoice extends JFrame {
	...
	public JunctionChoice(int difficulty) {
		super();
	...
	private void filldata() {
		...
		questiontext.setText("Which junction would you like to work with?");
	...
	private void makeandplacecomponents() {		
		submit.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				if (a.isSelected())
					question.setjunctionchoice(a.getText().charAt(0));
				else
					question.setjunctionchoice(b.getText().charAt(0));
				close();
			}
		});
		group.add(a);
