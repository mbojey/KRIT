...
public class MCQuestion extends JFrame {
	int subject = 01;
	...
	String[] first = {"For each of the following statements, please indicate how true it is for you using the following scale:\n"+
		"1\tNot at all true\n2\n3\n4\tSomewhat true\n5\n6\n7\tVery true\n"+"“The task” in the statements below refers to the exercises in PHYS 122",
	...
	public MCQuestion(int place) {
		super();
		this.place = place;
		try {
			writer = new PrintWriter(new BufferedWriter(new FileWriter(file,
					true)));
			writer.println("Start of pre-use MC questions");
	...
	private void close() {
		writer.close();
		if (place == 1) {
			InputFrame frame1 = new InputFrame(0);
			frame1.setSize(416, 700);
			frame1.setVisible(true);
		}
		else  if(place == 0){
			MCQuestion frame1 = new MCQuestion(1);
