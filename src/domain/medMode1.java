...
public class medMode1 extends Mode1 {
	...
	private void addwrongsolutiontext() {
		...
		wrongsolutions.add("-" + v1 + "V - " + r1 + "Ω*I3 + " + r2 + "Ω*I2 - "
				+ v2 + "V = 0");
		wrongsolutions.add(v1 + "A - " + r1 + "Ω*I3 - " + r2 + "Ω*I2 - " + v2
				+ "A = 0");
		wrongsolutions.add(v1 + "V + " + r1 + "Ω*I3 - " + r2 + "Ω*I2 + " + v2
				+ "V = 0");
		wrongsolutions.add(v3 + "A - " + r2 + "Ω*I2 - " + v2 + "A + " + r3
				+ "Ω*I1 = 0");
		wrongsolutions.add(v3 + "V + " + r2 + "Ω*I2 - " + v2 + "V - " + r3
				+ "Ω*I1 = 0");
		wrongsolutions.add(v3 + "V - " + r2 + "Ω*I2 + " + v2 + "V + " + r3
				+ "Ω*I1 = 0");
