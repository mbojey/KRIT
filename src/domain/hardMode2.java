...
public class hardMode2 extends Mode2 {

	public double v1, v2, v3, r1, r2, r3, r4, i1, i2, i3;
	...
	public Boolean[] exists = { true, true, true, true, true, true, true, true,
			true, true };
