...
public class medMode2 extends Mode2 {

	public double v1, v2,v3, r1, r2, r3, i1, i2, i3;
	...
	public Boolean[] exists = {true,true,true,true,true,true,false,true,true,true};
	...
	private void addhintstext() {
		hints.add("Conservation of charge means that current in must equal current out,\n"
				+ "follow the arrows.");
		hints.add("Conservation of energy and Kirchhoff's loop rule tell us that the \n"
				+ "voltage gained and lost around a loop must equal zero.");
		hints.add("Remember the sign conventions, when going with the current going \n"
		...
		hints.add("Remember the first equation, I1+I2=I3, and the values for\n"
				+ " I1, " + i1 + " and I2, " + i2);
	...
	private void addquestiontext() {
		...
		questions.add("With your answers for I2 and I1, what is the value of I3?\n1) "+solutions.get(0)+"\n I3 = "+i3+"A\n I1 = "+i1+"A");
	}

	private void addsolutiontext() {
		solutions.add("I2 = I1 + I3");
		solutions.add("-" + v1 + "V + " + r1 + "Ω*I3 + " + r2 + "Ω*I2 + " + v2
				+ "V = 0");
		solutions.add("-" + v3 + "V + " + r2 + "Ω*I2 + " + v2 + "V + " + r3
				+ "Ω*I1 = 0");
		solutions.add("" + i2 + "A");
		solutions.add("" + i1 + "A");
		solutions.add("" + i3 + "A");
	...
	private boolean verifystep0(String answerstring) {
		...
		StudentData.student.Roll_over(new Vertex<String>("Understanding", 3),
				new Vertex<String>("Understanding1", 3),
				dateFormat.format(date) + "," + 2 + "," + 1 + "," + 0 + ","
						+ (Math.abs(answer) < 0.000005 && valid));
		}catch(Exception e){
			valid = false;
			StudentData.student.enter_evidence(currents, 1);
			StudentData.student.Roll_over(new Vertex<String>("Understanding", 3),
